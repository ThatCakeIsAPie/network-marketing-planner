...
class PlannerRepository(
    ...
    suspend fun saveSettings(settings: PlannerSettings) {
        ...
        dao.upsertPrefs(
            current.copy(
                ...
                customerProfitPercent = settings.customerProfitPercent,
                includeCustomerProfit = settings.includeCustomerProfit,
    ...
    private fun defaultPrefs(): PrefsEntity = PrefsEntity(
        ...
        customerProfitPercent = PlannerSettings.DEFAULT_CUSTOMER_PROFIT,
...
private fun PrefsEntity.toSettings() = PlannerSettings(
    bvPerPv = bvPerPv,
    customerProfitPercent = customerProfitPercent,
    includeCustomerProfit = includeCustomerProfit,
